...
con_disad_cor <- con_disad2 %>% 
  select(pr_std_hs_or_low, pr_std_female_hh, pr_std_pov, 
         pr_std_pubassi, pr_std_unemprate)
...
saveRDS(
  con_disad2, 
  "C:/Users/User/OneDrive/Github Desktop/replication-code_concentrated-disadvantage-index/R Code/Data/(created) concentrated disadvantage items.RDS"
)
